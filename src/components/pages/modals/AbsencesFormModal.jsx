...
export default function AbsenceFormModal({ isFormOpen, toggleFormOpen }) {
    ...
    return (
        <div
            className={`fixed inset-0 bg-white transition-transform sm:transition-all duration-300 transform z-40 p-8 sm:w-full sm:max-w-150 sm:m-auto sm:h-min sm:rounded-3xl shadow-lg ${
                isFormOpen
