...
export default function AbsenceFormModal({
    ...
    return (
        <div
            className={`fixed w-screen h-[100dvh] bg-white transition-transform sm:transition-all duration-300 transform z-40 p-8 sm:w-full sm:max-w-150 sm:m-auto sm:h-min sm:rounded-3xl shadow-lg ${
                isFormOpen
