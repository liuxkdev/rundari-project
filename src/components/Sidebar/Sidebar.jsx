...
export default function Sidebar({ isOpen, toggleSidebar }) {
    return (
        <aside
            className={`sm:shadow-none shadow-xl fixed sm:static bg-white h-full w-[240px] z-40 transition-transform duration-300 grid grid-rows-[auto_1fr_auto] rounded-tr-2xl ease-in-out ${
